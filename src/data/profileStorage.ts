...
function getDb(){if(!firebaseConfig.apiKey||!firebaseConfig.projectId||!firebaseConfig.appId)throw new Error("Firebase configuration is missing.");return getFirestore(getFirebaseApp());}
